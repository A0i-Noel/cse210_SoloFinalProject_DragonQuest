...
namespace cse210_FinalProject_DragonQuest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            cast["Desert"] = new List<Actor>();
            cast["Tree"] = new List<Actor>();
            cast["Sea"] = new List<Actor>();
            cast["Water"] = new List<Actor>();
            cast["sMountain"] = new List<Actor>();
            cast["hMountain"] = new List<Actor>();
            ...
            for(int i =0; i <200; i++)
            {
                ...
                int x = r1.Next(0, 2736);
                int y = r2.Next(760, 3468);
            ...
            MoveActorsAction _MAA = new MoveActorsAction(physicsService);
